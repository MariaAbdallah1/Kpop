...
function reloadCard(){
    ...
    let totalPrice = 0;
    let countgroup = 0;
    let group = ["EXO", "Stray Kids", "Seventeen", "Blackpink", "BTS", "Junkook", "SuperM"];
    let mfanCoupons = ["Multifan159", "Multifan456"];
    let fanCoupons = ["realfan753", "realfan852"];
    ...
    if(countgroup > 2 && totalPrice > 1000){
        totalPrice = totalPrice * 0.8;
    }
    let countcm = 0, countcf = 0;

    mfanCoupons.forEach(element => {
        if(coupon == element){
            countcm = countcm +1;
        }
    });
